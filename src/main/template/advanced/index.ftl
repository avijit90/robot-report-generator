        ...
        <div class="main-panel">
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Github :<a
                            href="https://github.com/avijit90/robot-report-generator" target="_blank"><u>robot-report-generator</u> </a></span>
