...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <a href=${path_to_Report} class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i> Report</a>
        <a href=${path_to_Output} class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i> Output</a>
        <a href=${path_to_Log} class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i> Log</a>
    </div>
</nav>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
        <h5><b><i class="fa fa-dashboard"></i> Overall Statistics Dashboard</b></h5>
    </header>

    <div class="row">
        <div>
            <div style="float:left; width:25%; height:100%; margin-right: -25px;">
                <div style="border-radius: 50%; width: 100px; height: 100px; background: ${product.status}; margin-left: 70px; text-align: center; line-height: 95px">
